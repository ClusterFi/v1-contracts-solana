...
use crate::{
    ...
    DepositObligationCollateralAccounts, Obligation,
};
...
pub fn process_deposit_obligation_collateral(
    ...
    check_refresh_ixs!(ctx, deposit_reserve);
    ...
    lending_operations::refresh_reserve(deposit_reserve, &clock, None)?;
...
#[derive(Accounts)]
pub struct DepositObligationCollateralCtx<'info> {
