...
use crate::{
    ...
    Obligation, WithdrawObligationCollateralAccounts,
};
...
pub fn process_withdraw_obligation_collateral(
    ...
    let close_obligation = {
        ...
        let authority_signer_seeds =
            gen_signer_seeds!(lending_market_key, lending_market.bump as u8);
...
#[derive(Accounts)]
pub struct WithdrawObligationCollateralCtx<'info> {
