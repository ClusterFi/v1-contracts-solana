...
use crate::{
    ...
    utils::{
        fraction::{bps_u128_to_fraction, fraction, Fraction},
        slots, FractionExtra,
    },
    xmsg, CalculateLiquidationResult, LendingMarket, LiquidationParams, Obligation,
...
fn calculate_liquidation_bonus(
    ...
    let max_bonus_bps = min(max_bonus_bps, u16::MAX);
...
fn calculate_autodeleverage_threshold(
    ...
    let liquidation_threshold_pct = autodeleverage_reserve.config.liquidation_threshold_pct;
